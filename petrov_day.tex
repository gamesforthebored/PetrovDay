...
\usepackage[paperwidth=5.5in, paperheight=8.5in, top=0.5in, bottom=0.75in, inner=0.5in, outer=0.5in]{geometry}
...
\begin{itemize} \itemsep0pt \parskip0pt \parsep0pt
	\item a \myul{2pt}{0.5pt}{1pt}{candelabrum} with eight slots,
...
dripping wax. Have a \myul{2pt}{0.5pt}{1pt}{printed copy of this}
\myul{2pt}{0.5pt}{1pt}{booklet} ready.
...
\stagedir{Remove the lighter/matches from the table.}

\begin{center}
\includegraphics[width=1in]{images/candelabrum_1.png}
\end{center}
...
{Prometheus Bound, Aeschylus (circa 450 BC)\footnote{\textbf{Greek:} Aeschylus,
...
\blockquote{\textit{ἆρ᾽ οὖν ὑμῖν οἱ παλαιοὶ λόγοι ἀλήθειαν ἔχειν τινὰ δοκοῦσιν;
[...] τὸ πολλὰς ἀνθρώπων φθορὰς γεγονέναι κατακλυσμοῖς τε καὶ νόσοις καὶ ἄλλοις
πολλοῖς, ἐν οἷς βραχύ τι τῶν ἀνθρώπων λείπεσθαι γένος. --- πάνυ μὲν οὖν πιθανὸν
τὸ τοιοῦτον πᾶν παντί. --- φέρε δή, νοήσωμεν μίαν τῶν πολλῶν ταύτην τὴν τῷ
...
which was caused by the famous deluge.}{Laws, Plato (circa 350 BC)
...
manifest, lord of good deeds.}{Rosetta Stone (circa 196 BC)\footnote{Budge, E.A.\
...
Instead of telling his superiors what the system was saying, Petrov told them it was a false alarm---despite not really knowing this was the
case.
...
on most bombs, to prevent accidental or unauthorized detonation.
...
Take the two unlit candles from the candelabrum and, without lighting
either, hold them near the flame of the candle you just placed in the
candelabrum.}
...
That we can turn our labors to other, greater things---
...
behold the fullness of our knowledge, and can search it with a word. Tools from
across the earth are at our fingertips.
...
fear, and free for all things to come. So say we one---
