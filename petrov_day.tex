...
A special note on COVID-19: We have attempted to update the ceremony to
accommodate social distancing needs while hewing to the intentions of the
original.

We recommend:
\begin{itemize} \itemsep0pt \parskip0pt \parsep0pt
	\item Conduct the ceremony outside
	\item Forgo the potluck
...
\stagedir{Light a taper with the first candle, which represents the invention
of fire. Use the taper to light the second candle, which represents the
evolution of language.}

\candlePassing

\stagedir{The Keeper of the Flame holds the candle then directs each person in
the circle to speak. Speak your name and the time (year) of your earliest
memory.

\candelabrum{images/candelabrum2.png}

When everyone has spoken, return the candle to its place.}
...
\stagedir{Light a taper from the second candle, which represents language. Use
it to light the third candle, which represents agriculture.}
...
\stagedir{The Keeper of the Flame takes the third candle, which represents
agricultural society, and walks the permiter of the group.

\candlePassing

Extinguish it. Return it to its place.}
...
\stagedir{
Light a taper from the third candle, which represents writing, light the fourth
candle with the taper, which represents the scientific method.

\candelabrum{images/candelabrum4.png}

% TODO: Replace this with a better written thing
Write down something surprising you learned in the past week and put it in
the middle, on top of the pile of ancestors' names. When everyone
...
\stagedir{Extinguish the candle. Then return it to its place.}
...
\stagedir{Note the fourth candle, which represents the progress of science.

Touch a taper to each of the other three candles in turn, until it is lit. Then
light the fourth candle with the taper. Extinguish the taper.}
...
\stagedir{Take the fourth candle, which represents science, and place it
forward on the table. Each person reading a quote should step up to the fourth
candle, read the quote, then step away. Repeat for each quote in this
section.}
...
\stagedir{Return the candle to its place.}
...
\stagedir{Light a taper from the fourth candle, which represents science, light
the fifth candle with the taper to represent industrialization.}
...
\stagedir{Take the fifth candle, which represents industry. Open the box of
papers. Hold the candle over the stack of papers, which represent our history,
our knowledge, our lore, our civilization...

Open the box. Hold the flame close to the pile. Allow wax to fall. Keep the
candle there as the next section is read.}
...
\stagedir{Return the candle to its place without igniting the pile.}
...
\stagedir{Return the sixth candle to its place}
