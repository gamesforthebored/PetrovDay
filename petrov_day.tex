...
{Prometheus Bound, Aeschylus (c. 450 BC)\footnote{Greek: Aeschylus,
...
English: Cookson, G.M., trans.\ (1922). \textit{Four Plays of Aeschylus}
(p.\ 167). Holywell Press.
...
Greek: Plato, \textit{Laws} 3.677a. \href{https://www.perseus.tufts.edu/hopper/text?doc=Plat.+Laws+3.677&fromdoc=Perseus:text:1999.01.0165}{Link}

English: Plato. 1875. \textit{Laws}. Translated by B. Jowett.
\href{https://en.wikisource.org/wiki/Laws_(Jowett)/Book_III}{Link}

Date: Adams, J.P.\ (2008, May 28). \textit{Platonic Chronology and Writings}.
\href{https://www.csun.edu/~hcfll004/platochron.html}{Link}
}
}
...
(1929). \textit{The Rosetta Stone in the British Museum} (pp.\ 75, 168--9). The
...
Opus Majus (1266) \footnote{Latin: Bridges, Henry, ed.\ (1898). \textit{The
`Opus Majus' of Roger Bacon} (vol.\ 2, p.\ 168). Clarendon press.
\href{https://archive.org/details/opusmajusofroger02bacouoft/page/168/mode/2up}
{Link}

English: Burke, Robert Belle, trans.\ (1962). \textit{The Opus Majus of Roger
Bacon} (vol.\ 2, p.\ 584). Russell \& Russell Inc.
...
of the candle you just placed in the candelabrum, without lighting either.}
