...
Set up a \underline{table} in the middle of the room and gather everyone around.

Place on the table:
\begin{itemize} \itemsep0pt \parskip0pt \parsep0pt
	\item a \underline{candelabrum} with eight holders,
	\item \underline{seven unlit candles} in a \underline{tray} (but not in the
	candelabrum), and
	\item a \underline{lighter or matches} (and if the latter, \underline{a cup
	of sand or water} in which to douse them).
\end{itemize}

Take an \underline{eighth candle} and insert it into a \underline{candle-holder}
so that it can be moved around without dripping wax. Have a \underline{printed
copy} \underline{of this booklet} ready.
...
second, and third rank beside the image of the King Ptolemy, ever-living,
beloved of Ptah, the god manifest, lord of good deeds.}{Rosetta Stone (c. 196
BC)}
