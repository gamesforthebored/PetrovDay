...
Set up by putting the table in the center of the area. Place the lanterns (with unlit candles) on the ground beside it, and on the table place the lighter, the taper and its holder, the snuffer, the container for the papers, and papers/pens. The lanterns will be placed on the table during the ceremony as they are brought into prominence.

The Keeper of the Flame should pocket the red light, using it to light the way after the ceremony ends.

As each person arrives, they should take two pieces of paper from the table, and (if necessary) a pen.
...
\stagedir{Light the first lantern, to represent the invention of fire. Place it on the table. Point
out the location of the nearest fire extinguisher.}
...
\stagedir{Light the taper from the first lantern, which represents the invention
of fire. Use the taper to light the second lantern, which represents the
evolution of language. Place it on the table. (After every transfer done in this way, replace the taper into its holder and snuff it out.)}

\candlePassing

\stagedir{The Keeper of the Flame lifts the second lantern high and then directs each person in
the circle to speak: \textrm{Speak your name and the year of your earliest memory}.
...
\stagedir{Via the taper, as before, take the flame from the second lantern, which represents language, and use
it to light the third lantern, which represents agriculture. Place the newly-lit lantern on the table.}
...
\stagedir{All should clear a path to enable the Keeper of the Flame to get from the center to the outside of the group. The Keeper of the Flame takes the third lantern, which represents agricultural society, walks the perimeter of the group, and returns to the center.
...
\stagedir{Via the taper, take the flame from the second lantern, which represents language, and use it to relight the third
lantern, to represent the invention of writing.
}
...
\stagedir{
Via the taper, take the flame from the third lantern, which represents writing, and use it to light the fourth
lantern, which represents the scientific method. Place it on the table.

\candelabrum{images/candelabrum4.png}

% TODO: Replace this with a better written thing
Write down something surprising you learned in the past week and, one at a time, put it in
the box along with the pile of ancestors' names. When everyone
has done this something, continue to the next page.}
...
Open the other three lanterns and touch the taper to each of the candles in turn, until it is lit. Then
light the fourth lantern with the taper. Snuff out the taper, and close all the lanterns.}
...
\stagedir{Via the taper, take the flame from the fourth lantern, which represents science, and use it to light the fifth
lantern, which represents industrialization. Place it on the table.
...
\stagedir{Take the fifth lantern, which represents industry, and open its window. Open the box of
papers. Tilt the lantern over the box of papers, which represent our history,
our knowledge, our lore, our civilization...
...
\stagedir{Close the window of the lantern and return it to its place without igniting the pile.}
...
\stagedir{Place an unlit lantern in the last spot on the table, to represent future
technology.}
...
\stagedir{Via the taper, take the flame from the fifth lantern, which represents industrialization, and use it to light the sixth
lantern, to represent the invention of computers.}
...
\stagedir{Place an unlit lantern in the second-to-last spot on the table, to represent
...
good and bad outcomes (with all three windows open) while the following is read}
...
\stagedir{Six people take the six lit lanterns, taking them from the table one at a time. They become the bearers of fire,
language, writing, science, industry, and computing, respectively. As each bearer reads, they should raise their lantern high, and lower it when finished.}
...
\stagedir{One at a time, in that order, the bearers of fire, language, writing, science, industry, and computing return their lanterns to the table, with open windows. While this is happening, all other participants should silently read the remaining text in the booklet, and put away their booklet and any lights they may be carrying. The former Bearer of Computers waits till this is finished before continuing.}

\textit{(Former Bearer of Computers)}: May we see the day when none need fear
anything.

\stagedir{All close their eyes, except the Keeper of the Flame. The Keeper of the Flame quickly extinguishes all the lanterns, and says:}
...
\stagedir{After a few moments in darkness, the Keeper of the Flame turns on a red light, marking the end of the ceremony.}
