...
\skull{images/H_floresiensis.png}{Homo floresiensis}
\skull{images/H_habilis.png}{Homo habilis}
\skull{images/H_heidelbergensis.png}{Homo heidelbergensis}
\skull{images/H_neanderthalensis.png}{Homo neanderthalensis}
...
\stagedir{Pass the candle once all the way around the room. As the candle is
being passed, take a moment to recall your earliest memory. When you hold the
candle give your first name then pass it on.
...
They gave names to people around them. They gave names to animals and plants;
to actions and to places and to strategies. They called some of these things
good and some bad. They learned to share knowledge and they learned to
deceive. They built families and communities.

They began the long process of taming the wilderness. Their tribes grew to
cities.
...
forgotten. In that world, stories lasted only as long as memory, monuments
only as long as wood. For two hundred thousand years, nothing but genes
survived.

\divider

Though they could not preserve knowledge over generations, they could preserve
domesticated plants and animals. They saved the best and through the slow
march of humans imprinting their will on nature the world got easier. And then
some few started writing, and the equilibrium between learning and forgetting
was broken.
...
%rulers of some of these civilizations came to realize that they did not want
%to be forgotten. Some built monuments. About 5,000 years ago, some began to
%write.
...
offerings shall be given to the priests who serve in the temples. And a
...
the 1st of Thoth for five days ... This decree shall be inscribed on a stela
of hard stone in hieroglyphic and demotic and Greek characters and set up in
each of the first, second, and third temples beside the image of the ever
living king.}{The Rosetta Stone (ca. 196 BC)}
...
Then, everyone write something surprising you learned in the past week on your
paper and put it in the middle. When everyone has written something, continue
to the next page.}
...
the start of an accumulation of knowledge. This could have begun a slow
transition into the modern era. Instead, 81 years after Roger Bacon, history
was derailed by a great plague.
...
\page{
\blockquote{By calculations similar to these may be determined universally,
what expectations are warranted by any experiments, according to the different
number of times in which they have succeeded and failed; or what should be
thought of the probability that any particular cause in nature, with which we
have any acquaintance, will or will not, in any single trial, produce an
effect that has been conjoined with it.}{Rev. Thomas Bayes, An Essay towards
...
Each of these discoveries significantly changed society and all occurred over
little more than a century. The advancement of human knowledge was
accelerating.
...
The age of industrialization fundamentally remade human civilization. Many of
the rules upon which human society was built were rewritten by the power of
steam and electricity. The movement of information was revolutionized by the
telegraph and the telephone. The world was made smaller by the railroad and
the automobile.
...
\page{
% Sneaky quote
In 1939, Adolf Hitler figured how to effectively use film and radio for
propaganda, when these were new,World War II began, and the exercise of
power at scale changed forever.
...
%myself before an assembly of men who believed the opposite of what I wished
%to say and who wanted the opposite of what I believed in. Then I had to spend
%a couple of hours in persuading two or three thousand people to give up the
...
Starting in 1939 and continuing until 1945, World War II killed about 60
million people. Had it gone differently, it's likely that the entire world
would have fallen under a single totalitarian regime.
...
%estimates of how unlikely it was for life to arise and to advance to the
%point where we are now, means that there must be some filter further in our
%future, which prevents most life from spreading through the stars. Therefore,
%either our model of the past or of the universe is very substantially wrong,
%or there is an obstacle in our future which most intelligent civilizations
%fail to pass. We have several ideas about what that obstacle might be.
...
Hold the flame close, allow wax to fall. Keep the candle there as the next
section is read.}
...
%twenty-five years. Workers entered the field around 1950, and even around
%1960, with high hopes that are very far from having been realized in 1972. In
%no part of the field have the discoveries made so far produced the major
%impact that was then promised.}{James Lighthill (1973)}
%
%\divider
%
...
%best guess at the chance that there will be disasters of different types
%before 2100. The median estimate was a 19\% chance of human extinction.
...
%\divider
%
%\stagedir{Take the sixth candle, and read the following.} \blockspacing{By
%the power of computation, the power of my mind is amplified. I can see whole
%the knowledge of mankind, a great fractal pattern of summaries and details
%and summaries-of-summaries and details-of-details and search it all with a
%word.} \stagedir{Take the candle and hold it near the seventh and eight
%candles, which represent good and bad futures. Then pull it back, and return
%it to its place.}
...
Get up. Stretch. Turn on the lights.
